      ...
      <div className="p-3">
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-semibold text-obsidian-text-primary mb-0.5 truncate">
              {persona.name}
            </h3>
            {persona.description && (
              <p className="text-xs text-obsidian-text-secondary line-clamp-2 leading-tight">
                {persona.description}
              </p>
            )}
          </div>
